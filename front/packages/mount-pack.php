...
<head>
    ...
    <title>Mount Rinjani Package - Happy Valley Rinjani</title>
...
<body>
    ...
    <section class="about1">
        <div class="about-me1">
            <h1>Mount Rinjani Package</h1>
        </div>
        <p>Experience the ultimate adventure with our carefully curated Mount Rinjani trekking packages. From beginner-friendly routes to challenging summit expeditions.</p>
    </section>


    <section>
        <div class="wrap">
            <h1>Sembalun Route Packages</h1>
            ...
            fetch('get_mount_packages.php')
                ...
                .then(packages => {
                    ...
                    if (packages.length === 0) {
                        list.innerHTML = '<div class="no-packages" style="text-align: center; padding: 40px; color: #666;"><p>No mount packages available at the moment.</p></div>';
                        return;
                    }
            ...
            card.innerHTML = `
                ...
                <div class="body">
                    ...
                    <div class="info-grid">
                        ...
                        <div class="pill">
                            <span class="pill-icon" aria-hidden="true">${routeIcon()}</span>
                            <div>
                                <div class="pill-label">Route</div>
                                <div class="pill-value">${packageData.route}</div>
                            </div>
                        </div>
                        <div class="pill">
                            <span class="pill-icon" aria-hidden="true">${alertIcon()}</span>
                            <div>
                                <div class="pill-label">Difficult</div>
