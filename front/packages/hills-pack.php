...
<head>
    ...
    <title>Hills Package - Happy Valley Rinjani</title>
...
<body>
    ...
    <section>
        <div class="wrap">
            <h1>Sembalun Hills Exploration</h1>
    ...
    <script>
            ...
            fetch('get_hills_packages.php')
                ...
                .then(packages => {
                    ...
                    if (packages.length === 0) {
                        list.innerHTML = '<div class="no-packages" style="text-align: center; padding: 40px; color: #666;"><p>No hills packages available at the moment.</p></div>';
                        return;
                    }
        ...
        function bookPackage(packageId) {
            ...
            alert(`Booking hills package ID: ${packageId}\nThis would redirect to booking page.`);
        }
    </script>
</body>
</html>