...
// --- BAGIAN PENGAMAN ---
// Kode ini HARUS ada di baris paling atas sebelum HTML apapun.
// Jika session 'loggedin' tidak ada, paksa user kembali ke login.php
if (!isset($_SESSION['loggedin']) || $_SESSION['loggedin'] !== true) {
    header("location: ../login.php");
    exit; // Stop script agar HTML di bawah tidak dimuat
}
// --- AKHIR BAGIAN PENGAMAN ---
?>
<!DOCTYPE html>
<html lang="id">
...
<body>
    <?php
    // Pastikan path db_connect ini benar
        ...
        <div class="content-wrapper">
            <div class="admin-controls">
                <div class="button-wrapper">
                    ...
                    <a href="logout.php" class="btn-secondary" style="background-color: #dc3545; text-decoration: none; display: flex; align-items: center; gap: 8px;">
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', () => {
            ...
            document.getElementById('packageForm').addEventListener('submit', (e) => {
                ...
                const url = isEditMode ? 'actions/update_package.php' : 'actions/add_package.php';
